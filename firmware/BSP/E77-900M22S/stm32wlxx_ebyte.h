...
#ifndef STM32WLXX_EBYTE_H
#define STM32WLXX_EBYTE_H
...
/**
 * @brief STM32WLXX EBYTE BSP Driver version number
 */
#define __STM32WLXX_EBYTE_BSP_VERSION_MAIN (0x01U) /*!< [31:24] main version   \
                                                    */
#define __STM32WLXX_EBYTE_BSP_VERSION_SUB1 (0x03U) /*!< [23:16] sub1 version   \
                                                    */
#define __STM32WLXX_EBYTE_BSP_VERSION_SUB2 (0x00U) /*!< [15:8]  sub2 version   \
                                                    */
#define __STM32WLXX_EBYTE_BSP_VERSION_RC                                       \
  (0x00U) /*!< [7:0]  release candidate */
#define __STM32WLXX_EBYTE_BSP_VERSION                                          \
  ((__STM32WLXX_EBYTE_BSP_VERSION_MAIN << 24) |                                \
   (__STM32WLXX_EBYTE_BSP_VERSION_SUB1 << 16) |                                \
   (__STM32WLXX_EBYTE_BSP_VERSION_SUB2 << 8) |                                 \
   (__STM32WLXX_EBYTE_BSP_VERSION_RC))

/**
 * @brief Define for STM32WLXX_EBYTE board
 */
#if !defined(USE_STM32WLXX_EBYTE)
#define USE_STM32WLXX_EBYTE
#endif
